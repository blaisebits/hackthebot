** This is customed version of the Robopages repo, the original README has be kept for completeness.
...
### Function filtering
You can filter functions by name or by keyword. Keywords are assigned in the function description as a comma separated list of strings.
* ReconAgent
* EnumAgent
* ExploitAgent
* PostExAgent
