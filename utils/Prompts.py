...
def get_exploit_step_status_template()->ChatPromptTemplate:
    system_template = ("You are a world class exploit analyzer. Use the following criteria to determine the values"
                       ...
                       "For determining `Create initial access exploit to the target` the task's the output should be complete and functional python code.\n"
                       "* Initial Access Exploit code may contain placeholders values like <command>, this is to be considered valid code."
